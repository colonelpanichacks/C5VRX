...
/**
 * Standard 8x8 monochrome bitmap font (ASCII 32 ' ' to 126 '~').
 * Each character is 8 bytes; each byte represents 1 horizontal row of 8 pixels.
...
static const uint8_t s_font8x8[96][8] = {
    ...
    {0x7C, 0xC6, 0xC6, 0xC6, 0xD6, 0xDE, 0x7C, 0x0E}, /* Q 81 */
    ...
    {0x1C, 0x36, 0x30, 0x7C, 0x30, 0x30, 0x78, 0x00}, /* f 102 */
    ...
    {0x00, 0x00, 0x7C, 0xC0, 0x7C, 0x06, 0xF8, 0x00}, /* s 115 */
    {0x10, 0x30, 0x7C, 0x30, 0x30, 0x36, 0x1C, 0x00}, /* t 116 */
    ...
    {0x00, 0x00, 0xC6, 0xCC, 0x7C, 0x0C, 0x78, 0x00}, /* y 121 */
